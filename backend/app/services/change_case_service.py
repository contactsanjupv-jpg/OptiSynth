...
def rank_change_case(organization_id: int, change_case_id: int) -> list:
    ...
    for r in ranked:
        ...
        experiment_description = _minimum_experiment_description(r, target_value, direction)
...
def _minimum_experiment_description(ranked_candidate: dict, target_value: float, direction: str) -> str:
...
def generate_report(organization_id: int, change_case_id: int, organization_name: str) -> str:
    ...
    return report_builder.build_qualification_report(case, ranked_results, n_historical_rows, organization_name)
